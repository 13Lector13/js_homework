...
!!'false' == !!'true'
/*
Оператор ! приводит аргумент к логическому типу true/false, а атем возвращает противоположное значение
При !! тоже самое, но потом снова значение инвертируется
'false' это true, а !'false' - false, значит !!'false' будет true. Аналогично и с !!'true'. По итогу:
true == true, что есть true
